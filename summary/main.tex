...
% This statement may not be true, from my understanding that, even the traditional framework are MVC-based, separating Model Visual Control components and usually event-driven, though an event-loop is always running, I suspect that FaaS will anyway have a listener running also
...
% This part you need to refine, I tried to modify a little bit, it is better for you to go through again
