...
key2=sample ${key1}
    ...
    \bigskip
    \begin{code}[caption=Deploy command, label={lst:rln_command_deploy}]
$ restlessness deploy
...
$ restlessness deploy --env production users
    ...
    \bigskip
    \begin{code}[caption=New command, label={lst:rln_command_new}]
$ restlessness new rln_project
    ...
    \bigskip
    \begin{code}[caption=Dev command, label={lst:rln_command_dev}]
