\begin{abstract}
    ...
    Serverless Framework has emerged as one the major framework that allow the usage
    of the homonym paradigm in a simple way, and introducing a level of abstraction
    regarding the underlying structure of the chosen cloud provider.
    Despite the functionalities introduced by Serverless, the developer has to take
    ...
    thus allowing to find and correct critical issues, whose main ones were: Cold start
    handling, use of the non relational database mongodb, and limitations on the
    applications structure proposed at the beginning.
